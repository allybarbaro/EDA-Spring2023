...
```{r hisotgram, fig.height = 3, fig.width = 4}
#
ggplot(USGS.flow.data) +
...
> Answer: It depends on what you are looking to learn from the visualization of your data. 

## Ending discussion

What did you learn about the USGS discharge dataset today? What separate insights did the different graph types offer?
> Answer: It has a large variability, a lot of NA or no data, and can be represented in many different ways. 


How can multiple options for data exploration inform our understanding of our data?

> Answer: The ability to plot different variables against each other, or observe one variable in different ways can provide many different insights into the distribution of our data.
...
> Answer: most of the mean discharges are between 0 and 100. 
