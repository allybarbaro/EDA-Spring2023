...
> Answer: The output of your package will show on your console.
...
> ANSWER: It is the Raw folder, which is within the data folder. 
...
> Answer: It became labeled with NA.
...
> Answer: When using time series data, if the NAs are towards the beginning of the series, you can remove the NAs. 
