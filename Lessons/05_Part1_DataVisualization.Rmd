...
#figure height and width could be written in the code, but putting it up there ^, means it will be applied to the whole r code chunk.
# Scatterplot
...
print(O3plot)
# ^ this is best practice, store your plot as an object, then print it

# Fix this code
O3plot2 <- ggplot(EPAair) +
  #geom_point(aes(x = Date, y = Ozone, color = "blue")) <-- this is the incorrect one
...
PMplot <- 
  ...
  geom_point()
print(PMplot)
#shape refers to the shape of the plot point
...
Nutrientplot3 <-
  ...
  geom_boxplot(aes(color = nutrient)) # Why didn't we use "fill"? color is the contour of the shape, while fill is the filling
print(Nutrientplot3)
