...
LTER.Nutrients.Data <- read.csv(here("Data/Raw/NTL-LTER_Lake_Nutrients_Raw.csv"), stringsAsFactors = TRUE)

LTER.Nutrients.Data$sampledate <- as.Date(LTER.Nutrients.Data$sampledate, format = "%m/%d/%y")

head(LTER.Nutrients.Data)
...
LTER.Nutrients.Processed <- LTER.Nutrients.Data %>%
